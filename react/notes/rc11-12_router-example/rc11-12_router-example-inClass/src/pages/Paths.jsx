...
const Paths = () => {
  ...
  return (
    <div className="container mt-4">
      ...
      <p className="fs-5">
        Join oytstanding companies with rewarding salaries. We offer the highest-demand IT skills YOU need for success! CHOOSE THE BEST COURSE FOR YOU Upgrade your career with the best online training led boy top IT experts!
      </p>
